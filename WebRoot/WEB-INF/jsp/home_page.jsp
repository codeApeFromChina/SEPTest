	...
	<div class="content">
								...
								<div class="hero-unit">
									<div class="row-fluid">
										<div class="span7 marketting-info">
											...
											<p>
												<s:a
													href="displayAction_showIterm.action?itermId=%{#sliderIterm.id}">...了解详情</s:a>
											</p>
										</div>
										<div class="span5" style="height : 400px">
		...
		<div class="container">
			...
			<div class="page-header">
				<span>
					<h2>二手物品</h2> <s:a href="displayAction_displayAll?requestType = 1">查看更多...</s:a>
				</span>
			</div>
			<div class="row-fluid">
				<ul class="thumbnails">
						...
						<li class="span4" id="${usedGood.id}">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<s:a
										href="displayAction_showIterm.action?itermId=%{#usedGood.id}">...了解详情</s:a>
								</div>
			...
			<div class="page-header">
				...
				<h2>二手书籍</h2>
				<s:a href="displayAction_displayAll?requestType = 1">查看更多...</s:a>
			</div>
			<div class="row-fluid">
				<ul class="thumbnails">
						...
						<li class="span4" id="${usedBook.id}">
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<s:a
										href="displayAction_showIterm.action?itermId=%{#usedBook.id}">...了解详情</s:a>
								</div>
							</div>
						</li>
					</s:iterator>
