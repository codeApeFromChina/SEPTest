      ...
      <div class="slider">
        <div class="container-fluid">
          <div id="heroSlider" class="carousel slide">
              ...
              <div class="active item">
                <div class="hero-unit">
                  <div class="row-fluid">
                    ...
                    <div class="span5">
                      <img src="${pageContext.request.contextPath}/img/placeholder.jpg" class="thumbnail">
                    </div>
                  </div>                  
                </div>
              </div>
            ...
            <a class="left carousel-control" href="#heroSlider" data-slide="prev">&lt</a>
            <a class="right carousel-control" href="#heroSlider" data-slide="next">&gt</a>
          </div>
        </div>
      </div>
      <!-- End: slider -->
        ...
        <div class="container">
          ...
          <div class="row-fluid">
            <ul class="thumbnails">
              <li class="span4">
                <div class="thumbnail">
                  <img src="${pageContext.request.contextPath}/img/placeholder-360x200.jpg" alt="product name">
                  <div class="caption">
                    <h3>Product name</h3>
                    <p>
